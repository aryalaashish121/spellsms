                ...
                >
                  ...
                  >
                    <div class="w-full h-5 pt-3 pl-4">
                      <h1 class="text-xs">Account Manager</h1>
                    </div>
                    <div class="flex-col mt-3">
                      <div
                        class="
                        ...
                        >
                          <template v-slot:activator>
                            <v-btn
                              ...
                              fab
                            >
                              <v-icon v-if="fabThree"> mdi-close </v-icon>
                              <v-icon v-else> mdi-cog </v-icon>
                            </v-btn>
                          </template>
                          <div class="-ml-1.5">
                            <tool-tip
                              v-for="(item, index) in creditTooltips"
                              :key="index"
                              :title="item.title"
                              :icon="item.icon"
                              :color="item.color"
                        ...
                        >
                          <template v-slot:activator>
                            <v-btn
                              ...
                              fab
                            >
                              <v-icon v-if="fabFour"> mdi-close </v-icon>
                              <v-icon v-else> mdi-help </v-icon>
                            </v-btn>
                          </template>
                          <div class="-ml-1.5">
                            <dialogue-tool-tips
                              v-for="(item, index) in dialogueToolTips"
                              :key="index"
                              :title="item.title"
                              :icon="item.icon"
                              :color="item.color"
...
import DialogueToolTips from "../../../components/DialougeToolTip.vue";
...
export default {
  ...
  data() {
    return {
      ...
      route: [{ route: "SMSBIT (RouteID: 116)", info: "5 SMS available" }],
