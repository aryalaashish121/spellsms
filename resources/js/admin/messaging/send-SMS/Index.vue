                  ...
                  "
                        ...
                        >
                            <v-card-text>
                                ...
                                <div
                                    class="mt-4"
                                    v-if="form_fields.schedule_later"
                                >
...
export default {
    ...
    methods: {
        ...
        async sendMessage() {
            ...
            formdata.append(
                "selected_numbers",
                self.form_fields.selected_numbers
            );
            formdata.append("contact_groups", contactgrouplist);
            formdata.append("message", self.form_fields.message);
            formdata.append(
                "remove_duplicate",
                self.form_fields.remove_duplicate
            );
            formdata.append(
                "remove_invalids",
                self.form_fields.remove_invalids
            );
            formdata.append(
                "remove_blacklist",
                self.form_fields.remove_blacklist
            );
